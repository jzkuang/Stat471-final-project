...
expenditure <- readxl::read_excel("stat-471-final-project/data/Expenditures per Pupil.xlsx")
...
inexperience <- readxl::read_excel("stat-471-final-project/data/Inexperienced Teachers and Principals.xlsx")
